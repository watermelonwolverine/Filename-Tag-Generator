...
__text = str(
    F'# {header}\n'
    F'\n'
    F'The program can be used in two different ways:\n'
    F'\n'
    F'1. Directly rename files via drag and drop\n'
    F'2. Generate names to use them elsewhere (like a VTT)\n'
    F'\n'
    F'## Renaming Files\n'
    F'\n'
    F'### Single\n'
    ...
    F'- The `{BASENAME}` and `{EXTENSION}` fields will also be disabled. You will have to adjust the basename and extension beforehand.\n'
    F'\n'
    F'Checkbox states:\n'
    F'\n'
